...
echo json_encode(['ok'=>true,'jobId'=>$id,'state'=>'candidate','candidateOnly'=>($data['candidateOnly']??null)===true,'narrativeAuthority'=>($data['narrativeAuthority']??null)===false,'clips'=>$clips,'result'=>$data],JSON_UNESCAPED_SLASHES|JSON_UNESCAPED_UNICODE);
