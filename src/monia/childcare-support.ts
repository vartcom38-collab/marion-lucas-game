...
export type ChildcareMode='none'|'nanny-home'|'nanny-travel'|'family-backup'|'planned-care'|'unarranged';
...
export function getChildcareSupport():ChildcareSnapshot|null{
  ...
  const mode:ChildcareMode=!snap.needed?'none':snap.mode==='travel-nanny'?'nanny-travel':snap.mode==='family-support'?'family-backup':snap.mode==='planned-care'?'planned-care':snap.mode==='nanny'?'nanny-home':'unarranged';
