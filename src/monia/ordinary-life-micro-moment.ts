...
function phrase(beat:OrdinaryLifeBeat){
 ...
 const map:Record<string,string>={
  ...
  'kitchen-reset':'Je remets machinalement deux ou trois choses en place.','water-plants':'Un geste simple, presque automatique.','shared-coffee':'Dominic reste là, tout près, pendant que le moment s’installe.','small-touch':'Un contact bref, naturel, sans interrompre ce qu’on faisait.','quiet-kitchen':'On reste dans la cuisine sans avoir besoin d’en faire une scène.','brief-checkin':'Quelques mots entre nous, simplement.','same-room-silence':'On partage le même silence, chacun dans son rythme.',
  'short-walk':'Je change d’air quelques minutes.','sunset-step-out':'Je sors juste un moment avant que la lumière tombe.'
 };
 return map[id]||({quiet:'Un petit moment calme passe.',practical:'Je m’occupe d’un détail du quotidien.',self:'Je prends quelques minutes pour moi.',social:'Un petit lien avec l’extérieur.',couple:'Un moment simple avec Dominic.',outing:'Je bouge un peu, sans programme.'}[beat.kind]);
}
