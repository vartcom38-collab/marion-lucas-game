...
const ACTIONS:Record<Place,Action[]>={
  ...
  family:[
    ...
    {id:'garden',label:'Prendre l’air autour de la maison',short:'Dehors',minutes:35,energy:0,stress:-4,relationship:1},
