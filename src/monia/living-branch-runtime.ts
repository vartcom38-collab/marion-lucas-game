...
export type LivingNode={id:string;entrySrc?:string;holdSrc?:string;choices:LivingChoice[];directorNext?:string[];fallbackMs?:number;framing?:{subject?:string;faceReadable?:boolean;movement?:string}};
...
const day1Nodes:Record<string,LivingNode>={
 ...
 D1_PHONE_MARINE:{id:'D1_PHONE_MARINE',fallbackMs:180,choices:[
