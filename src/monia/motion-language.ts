...
/**
 * Motion/body-presence vocabulary distilled from user-provided reference videos.
 * Lucas canon remains authoritative for identity and face.
 * Male references may inform silhouette, posture, gait, shoulder/torso presence,
 * contact mechanics and timing. Female/co-actor identity is ignored unless a scene
