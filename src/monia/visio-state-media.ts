...
const prompts={
  listening:'Photorealistic desktop video-call candidate of the exact same Lucas identity as the canonical reference. Quiet listening only: natural breathing, occasional blink, tiny eye movement toward camera, subtle head tilt, relaxed closed mouth, restrained attentive micro-reactions. Preserve face geometry, hair, eyes, stubble, tattoos, skin tone and natural ears exactly. No talking, no identity drift, no morphing, no text, no subtitles, no watermark, no zoom.',
  speaking:'Photorealistic desktop video-call candidate of the exact same Lucas identity as the canonical reference. Natural French conversation: subtle jaw and lip movement, realistic blinking, tiny head and eyebrow motion, believable breathing and posture. Preserve face geometry, hair, eyes, stubble, tattoos, skin tone and natural ears exactly. No exaggerated mouth motion, no identity drift, no morphing, no text, no subtitles, no watermark, no zoom.',
  reaction:'Photorealistic desktop video-call candidate of the exact same Lucas identity as the canonical reference. Silent warm micro-reaction: tiny eye movement, blink, slight breath, restrained half-smile, then settle naturally. Preserve face geometry, hair, eyes, stubble, tattoos, skin tone and natural ears exactly. No speaking, no identity drift, no morphing, no text, no subtitles, no watermark, no zoom.'
} as const;
