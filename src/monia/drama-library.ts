...
export const MONIA_DRAMA_LIBRARY: MonIADramaBrick[] = [
  {
    id: 'lucas-intro-canon',
    src: '/resources/lucas-intro.mp4',
    kind: 'video',
    actors: ['Lucas'],
    locationTags: ['generic', 'spain', 'madrid'],
    moods: ['neutral', 'tender', 'quiet', 'intense'],
    shotTags: ['close', 'medium-close'],
    loopable: false,
    dialogueSafe: true,
    reactionSafe: true,
    weight: 12,
  ...
  {
    id: 'marion-nimes-canon',
    src: '/resources/marion-nimes.mp4',
    kind: 'video',
    actors: ['Marion'],
    locationTags: ['nîmes', 'nimes', 'generic'],
    moods: ['neutral', 'tender', 'quiet', 'worried'],
    shotTags: ['close', 'medium-close', 'medium'],
    loopable: false,
    dialogueSafe: false,
    reactionSafe: true,
    weight: 12,
  ...
  {
    id: 'apartment-nimes-wide',
    src: '/resources/appartement-nimes.png',
    kind: 'image',
    actors: [],
    locationTags: ['appartement', 'nîmes', 'nimes', 'home'],
    moods: ['neutral', 'quiet', 'tender'],
    shotTags: ['medium', 'two-shot', 'detail'],
    loopable: true,
    dialogueSafe: false,
    reactionSafe: false,
    weight: 8,
