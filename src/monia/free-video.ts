...
const PROVIDERS:Provider[]=[
  ...
  {
    id:'hf-addlabsviral-ltx25',
    label:'LTX 2.5 ZeroGPU B',
    space:'https://addlabsviral-ltx-2-5.hf.space',
    spaceId:'addlabsviral/LTX-2.5',
    discover:true,
    // Public run signature: prompt, image, height, width, duration, seed,
    // decoder, auto_len, randomize_seed, enhance_prompt.
    payload:(prompt,image)=>[prompt,image,960,544,2.0,42,'conv',false,true,false],
  },
  {
    id:'hf-kpkp21-wan22',
