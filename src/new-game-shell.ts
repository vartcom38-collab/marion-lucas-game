...
function mount(){
 ...
 function renderPanel(){if(!state.tool){panel.hidden=true;return}panel.hidden=false;panel.dataset.tool=state.tool||'';panel.classList.toggle('era-1998',state.tool==='phone'&&state.year<2001);panel.classList.toggle('era-modern',state.tool==='phone'&&state.year>=2010);
